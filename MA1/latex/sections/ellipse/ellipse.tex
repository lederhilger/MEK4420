...
\input{sections/ellipse/subsections/elliptic_coordinates.tex}

\subsection{Translatory kinetic energy}
\input{sections/ellipse/subsections/translatory_kinetic_energy_ellipse.tex}

\subsection{Rotational kinetic energy}
\input{sections/ellipse/subsections/rotational_kinetic_energy_ellipse.tex}

\subsection{Added mass}
\input{sections/ellipse/subsections/added_mass_ellipse.tex}

\subsection{Elliptic integrals}
\input{sections/ellipse/subsections/elliptic_integrals.tex}

\subsection{The arithmetic-geometric mean}
\input{sections/ellipse/subsections/agm.tex}

\subsection{Discretizing the ellipse}
\input{sections/ellipse/subsections/discretizing_ellipse.tex}
