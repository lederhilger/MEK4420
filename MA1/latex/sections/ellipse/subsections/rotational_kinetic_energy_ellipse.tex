...
\[
w = i A e^{-2\zeta}, \qquad \Psi = Ae^{-2\xi}\cos{2\eta},
\]
...
\[
A e^{-2\xi} \cos{2\eta} - \frac{c^2 \omega \big( \cosh{2\xi} + \cos{2\eta} \big)}{4} = C.
\]
...
\[
T_{\mathrm{fluid}} = \frac{\varrho \omega^2 c^4}{16} \int_{0}^{2\pi} \sin^{2}{2\eta} \,\dee\eta = \frac{\pi \varrho \omega^2 c^4}{16}.
\]
