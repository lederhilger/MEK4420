...
\begin{Figure}
  \centering
  \resizebox{\textwidth}{!}{\includegraphics{phi_1_N160.pdf}}
...
\begin{Figure}
  \centering
  \resizebox{\textwidth}{!}{\includegraphics{phi_2_N160.pdf}}
  \captionsetup{type = figure}
...
\begin{Figure}
  \centering
  \resizebox{\textwidth}{!}{\includegraphics{addedmass_circle_N160.pdf}}
  \captionsetup{type = figure}
