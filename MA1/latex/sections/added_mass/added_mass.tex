...
T_{\mathrm{fluid}} = \frac{\varrho}{2} \int_{\Omega} q^2 \,\dee V, \quad q^2 = \absl{\nabla\Phi}^2 = \frac{\dee w}{\dee \ezh} \frac{\dee w^{\ast}}{\dee \ezh^{\ast}},
\end{equation}
...
The speed $q$ may be related to the velocity magnitude $U$ by assuming the modal superposition $\Phi(t;\xvec) = \symbf{U}(t) \cdot \symbf{\phi}(\xvec)$.
...
\[
\symbf{F} = -\deet\symbf{U}\colon\varrho\int_{\partial\Omega} \symbf{\phi}\otimes\nhat \,\dee S,
\]
where $S$ is the contour of the body, and $\otimes$ denotes the outer product.
$\symbf{\phi}$ is a vector containing the modes of translation,
\[
    \symbf{\phi}(\xvec, t) = \phi_1 \ihat + \phi_2 \jhat + \phi_6 \symbf{\hat{\omega}}_{\khat}.
\]
...
\begin{equation}\label{eq:added_mass}
    \addedmass = \varrho \int_{\partial\Omega} \symbf{\phi} \otimes \nhat \,\dee S
\end{equation}
