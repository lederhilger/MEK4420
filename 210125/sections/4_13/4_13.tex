...
\[
    \symbf{F} = -\varrho \deet U \int_{\partial\Omega} \phi\nhat \,\dee S,
\]
and the moment
\[
    \symbf{M} = -\varrho \deet U \int_{\partial\Omega} \phi \xvec\times\nhat \,\dee S.
\]
...
\]
A body moving with velocity $\symbf{U} = U_1 \ihat + U_2 \jhat$ and angular velocity $\symbf{\Omega} = U_6 \khat$ may have its potential expressed as a superposition
\[
