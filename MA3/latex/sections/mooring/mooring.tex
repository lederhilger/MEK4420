...
\]
where $m$ is the mass of the entire turbine, and $m_{11}$ is its added mass.
...
Either way, the period will be given in a similar manner as in surge, with the added mass of such a disk, halved, as we only consider half the disk,\footnote{\cite{kennard1967irrotational} \textsc{Kennard}, p.393}
\[
